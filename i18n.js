...
(function () {
  ...
  const AR = {
    ...
    'Grant edit access': 'منح صلاحية التعديل',
    'Revoke edit access': 'سحب صلاحية التعديل',
    'Grant this user edit access? They will be able to update and delete existing content on any page they can access, not just create new items.': 'منح هذا المستخدم صلاحية التعديل؟ سيتمكن من تحديث وحذف المحتوى الحالي في أي صفحة يملك صلاحية الوصول إليها، وليس فقط إنشاء عناصر جديدة.',
    'Revoke edit access? They will only be able to create new items from now on, not change or delete existing ones.': 'سحب صلاحية التعديل؟ سيتمكن فقط من إنشاء عناصر جديدة بعد الآن، دون تعديل أو حذف الموجود منها.',
    'Edit access granted': 'تم منح صلاحية التعديل',
    'Edit access revoked': 'تم سحب صلاحية التعديل',
