...
(function () {
  ...
  const AR = {
    ...
    'blog.more': 'المزيد من <em>القصص</em>',
    'Article': 'مقال',
    ...
    'Build the article from heading, paragraph and image blocks, in the order they should appear.': 'أنشئ المقال من عناصر عناوين وفقرات وصور، بالترتيب الذي يجب أن تظهر به.',
    ...
    'No blocks yet — add a heading, paragraph or image below.': 'لا توجد عناصر بعد — أضف عنوانًا فرعيًا أو فقرة أو صورة أدناه.',
